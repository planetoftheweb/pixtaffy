...
export const WHATS_NEW: WhatsNewEntry[] = [
  ...
  },
  {
    ...
    summary:
      'Presets get free-text art direction, sample previews, and in-place editing — plus fixes so your model choice is applied and remembered.',
    blurb:
      'Presets grew up. Each one can now carry free-text art direction — the guidance dropdowns can’t express, like "one central metaphor, airy negative space, no words in the image" — which rides along with every generation and shows as a clearable panel in the Presets menu. Hover any preset to see a sample image of what it produces, and use the ⋯ menu to rename, edit its art direction, overwrite, or delete in place. Under the hood, a family of settings bugs is gone: your model choice is applied to the actual generation and remembered across reloads, OpenRouter models like Seedream honor your Size setting, tiles report the model that really made them, the model picker is organized by provider, time-remaining estimates count down honestly, palette hex codes can no longer leak into the artwork as painted swatches, and the Expand wand now enriches your idea’s content instead of dictating fonts, colors, and layout.',
    publishedAt: Date.parse('2026-07-04T20:00:00Z'),
    version: '0.23.0',
    image: '/whats-new/whatsnew-v0.23.0.png',
    featured: true,
    sections: [
      {
        heading: 'Give a preset its own art direction',
        body: 'When saving a preset, fill the optional "Art direction" box with guidance the menus can’t capture — mood, composition rules, motifs, things to avoid. Applying the preset activates it for every generation until you clear it, so a bare idea like "Explain how nuclear fusion works" still comes out in your look.',
        steps: [
          { text: 'Presets → Save current as preset → add art direction in the optional box.', icon: 'Save' },
          { text: 'The active instructions show at the top of the Presets menu — clear them anytime with the ×.', icon: 'Eye' },
          { text: 'Edit any preset’s art direction in place via its ⋯ menu.', icon: 'Pencil' },
        ],
      },
      {
        heading: 'See what a preset produces before applying it',
        body: 'Hovering a preset now shows a sample image — the newest generation you made with matching settings — above its parameter list, so you can pick by eye instead of memory.',
        steps: [
          { text: 'Open the Presets menu and hover any row.', icon: 'Eye' },
          { text: 'The preview card shows a sample, the pinned settings, and any art direction.', icon: 'Image' },
        ],
      },
      {
        heading: 'Your settings apply and stay applied',
        body: 'A stale local cache could silently swap your model back on reload, rapid changes could clobber each other, and OpenRouter models ignored your Size choice. All fixed: the model you pick is the model that generates, it survives reloads, Seedream and friends deliver the aspect ratio you asked for, and every tile is labeled with the model that actually made it.',
        steps: [
          { text: 'Pick any model — including OpenRouter ones — and generate; the tile’s details show the true model.', icon: 'Check' },
          { text: 'Reload the app: your model, size, and style are exactly where you left them.', icon: 'Check' },
        ],
      },
      {
        heading: 'A wand that respects your dropdowns',
        body: 'Expand prompt used to bake fonts, colors, and layout into the text — fighting your Style and Colors settings. It now deepens the content only: the concepts, sections, subjects, and label wording that make the graphic teach, leaving the look to your tools.',
        steps: [
          { text: 'Type a bare idea and hit the wand — you get substance, not styling.', icon: 'Sparkles' },
          { text: 'Switch Style or Colors after expanding and the change actually takes effect.', icon: 'ArrowRight' },
        ],
      },
    ],
  },
  ...
  {
    id: 'v0.11.0-focus-mode-puts-your',
    title: "Focus mode puts your image front and center",
    summary: "Toolbar melts away as you scroll so the artwork gets the whole screen",
    blurb: "Your image takes the spotlight: the toolbar and prompt box now collapse automatically when you scroll or open a creation, and every overlay control \u2014 buttons, arrows, the version chip \u2014 hides until you hover. The version picker moved into a sleek in-image chip with a rich preview popover, and the plus button on the rail re-runs your last prompt in a single click.",
    publishedAt: Date.parse('2026-05-04T12:00:00Z'),
    version: '0.11.0',
    image: '/whats-new/whatsnew-v0.11.0.png',
  },
  {
    id: 'v0.10.0-a-tidier-generation-monitor',
    title: "A tidier generation monitor that stays out of your way",
    summary: "Dock the progress panel to a pill and see queued jobs at a glance",
    blurb: "The Active Generations panel can now dock into a compact pill showing how many jobs are running and queued \u2014 click to expand it whenever you want the full picture. Queued items are finally visible inside each batch, and starting a new run clears the stage immediately with a friendly \u201cGenerating\u2026\u201d placeholder so you always know something's happening.",
    publishedAt: Date.parse('2026-05-04T12:00:00Z'),
    version: '0.10.0',
    image: '/whats-new/whatsnew-v0.10.0.png',
  },
  {
    id: 'v0.9.0-page-through-big-folders',
    title: "Page through big folders and hop between versions",
    summary: "Gallery pagination for large folders plus up/down version shortcuts",
    blurb: "Big folders are easy to browse now: past 50 items the gallery adds pages with a choose-your-own page size, while counts and bulk actions still cover the whole folder. New up/down keyboard shortcuts cycle through an image's versions, and the browse arrows land on each creation's latest version \u2014 the one you usually want.",
    publishedAt: Date.parse('2026-05-04T12:00:00Z'),
    version: '0.9.0',
    image: '/whats-new/whatsnew-v0.9.0.png',
  },
  {
    id: 'v0.8.0-folders-toolbar-presets-and',
    title: "Folders, toolbar presets, and images that survive your VPN",
    summary: "Organize work into folders and recall favorite setups in one click",
    ...
    version: '0.8.0',
    image: '/whats-new/whatsnew-v0.8.0.png',
  },
  {
    id: 'v0.7.0-flip-through-your-gallery',
    title: "Flip through your gallery with arrows and tidy new views",
    summary: "Arrow-key browsing, thumbnail sizes, and a cleaner image grid",
    blurb: "Step through your creations without leaving the big preview \u2014 new arrow buttons and left/right keyboard shortcuts walk the whole gallery one image at a time. The gallery itself gets a thumbnail size picker, a show/hide details toggle, and tile buttons that stay out of sight until you hover, so your work reads as a clean wall of images.",
    publishedAt: Date.parse('2026-04-27T12:00:00Z'),
    version: '0.7.0',
    image: '/whats-new/whatsnew-v0.7.0.png',
  },
  {
    ...
    publishedAt: Date.parse('2026-04-27T12:00:00Z'),
    version: '0.6.0',
    image: '/whats-new/whatsnew-v0.6.0.png',
  },
  {
    ...
    version: '0.5.0',
    image: '/whats-new/whatsnew-v0.5.0.png',
  },
  {
    id: 'v0.4.0-gpt-image-2-arrives',
    title: "GPT Image 2 arrives with quality control and new sizes",
    summary: "Three OpenAI model tiers, a quality picker, and banner-wide ratios",
    blurb: "Pick the OpenAI model that fits the job: flagship GPT Image 2, budget-friendly GPT Image Mini, or the classic GPT Image 1.5 \u2014 all sharing the API key you already saved. A new quality dropdown lets you trade speed for polish, and GPT Image 2 unlocks fresh aspect ratios including widescreen, vertical, banner, and skyscraper shapes.",
    publishedAt: Date.parse('2026-04-21T12:00:00Z'),
    version: '0.4.0',
    image: '/whats-new/whatsnew-v0.4.0.png',
  },
  {
    id: 'v0.3.0-usage-stats-dashboard-for',
    title: "Usage stats dashboard for admins",
    summary: "See images per day, top models, styles, and your most active users",
    blurb: "The Admin page now has a Stats tab with a live dashboard: total images and refinements, daily generation and signup charts, breakdowns by model, graphic type, style, and aspect ratio, plus a top-10 leaderboard of your most prolific creators. It's all computed fresh on demand with a one-click refresh.",
    publishedAt: Date.parse('2026-04-21T12:00:00Z'),
    version: '0.3.0',
    image: '/whats-new/whatsnew-v0.3.0.png',
  },
  {
    id: 'v0.2.0-admin-tools-and-a',
    title: "Admin tools and a stronger, safer account system",
    summary: "New admin panel plus tighter security and a cleaner Settings page",
    blurb: "Administrators get a full control room: a searchable user table with actions to suspend accounts, clear keys, promote admins, and more. Behind the scenes, admin access is now verified server-side so it can't be faked, and security rules are locked down across the board. The Settings page also got a cleanup, with API keys that reliably stick after saving.",
    publishedAt: Date.parse('2026-04-21T12:00:00Z'),
    version: '0.2.0',
    image: '/whats-new/whatsnew-v0.2.0.png',
  },
  {
    ...
    version: '0.1.0',
    image: '/whats-new/whatsnew-v0.1.0.png',
  },
];
